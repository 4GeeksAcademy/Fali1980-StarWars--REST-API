...
Revision ID: 56fa9ed702ab
Revises: b1291c7ec883
Create Date: 2024-05-12 20:56:17.100646
...
revision = '56fa9ed702ab'
down_revision = 'b1291c7ec883'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('favorites_planets', schema=None) as batch_op:
        ...
        batch_op.drop_constraint('favorites_planets_planets_id_fkey', type_='foreignkey')
...
def downgrade():
    ...
    with op.batch_alter_table('favorites_planets', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('favorites_planets_planets_id_fkey', 'planet', ['planets_id'], ['id'])
        batch_op.drop_column('planet_id')

    with op.batch_alter_table('favorites_characters', schema=None) as batch_op:
        batch_op.add_column(sa.Column('characters_id', sa.INTEGER(), autoincrement=False, nullable=True))
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key('favorites_characters_characters_id_fkey', 'character', ['characters_id'], ['id'])
